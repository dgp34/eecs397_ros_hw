...
// wsn, Nov, 2016
// reused with light edits in this package by dgp34
...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_poseStamped.pose.position.y = -0.70;
    object_poseStamped.pose.position.z = 0.583; //pose w/rt world frames   //Need to adjust for pulley height? Which may be the same as for the block anyway
    ...
    object_dropoff_poseStamped.pose.position.z = 0.84; 
}
